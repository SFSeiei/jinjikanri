...
public class HKN0005LicenseServiceImpl implements HKN0005LicenseService {
	...
	public int busInsert(HKN0005LicenseEntity hkn0005LicenseEntity) {
		 ...
		 */
		List<HKN0005LicenseEntity> selectBusId = this.hkn0005LicenseMapper.selectBusId(busId, classes, staffCd, licenseId);
		/**
	...
	public Map<Integer, String> selectBusId(Integer busId, Integer classes, Integer staffCd, String licenseId) {
		return this.selectBusId(busId, classes, staffCd, licenseId);
	}
